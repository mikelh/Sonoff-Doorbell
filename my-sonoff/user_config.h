...
#define CFG_HOLDER             0x20171210        // [Reset 1] Change this value to load following default configuration parameters
...
#define USE_DFPLAYER                              // Add support for DFPlayer mini MP3 with hardware serial interface (+t.b.d. code)
#define USE_DFPLAYER_SOFTSERIAL						    // Add support for DFPlayer mini MP3 with software serial interface (+t.b.d. code)
